...
pub struct AppSettings {
    ...
    pub filen_s3_endpoint: Option<String>,
    pub filen_s3_region: Option<String>,
    pub filen_s3_bucket: Option<String>,
    pub filen_s3_access_key: Option<String>,
    pub filen_s3_secret_key: Option<String>,
...
impl Default for AppSettings {
    fn default() -> Self {
        Self {
            ...
            goldberg_path: None,
            rawg_api_key: None,
            storage_backend: "bunnycdn".to_string(),
            catalog_url: String::new(),
            github_token: String::new(),
            github_owner: String::new(),
            github_repo: String::new(),
            github_path: "catalog.json".to_string(),
            github_branch: "main".to_string(),
            webdav_url: String::new(),
            webdav_username: String::new(),
            webdav_password: String::new(),
            filen_s3_endpoint: None,
            filen_s3_region: None,
            filen_s3_bucket: None,
            filen_s3_access_key: None,
            filen_s3_secret_key: None,
